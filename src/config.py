...
class TrainingConfig(BaseModel):
    ...
    random_forest_estimators: int = Field(default=100, ge=1)
    random_forest_max_depth: int = Field(default=5, ge=1)
    random_forest_min_samples_leaf: int = Field(default=2, ge=1)
    random_state: int = 42
