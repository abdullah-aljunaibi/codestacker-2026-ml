...
from src.summary import generate_anomaly_summary_with_method
...
def render_analysis(name: str, document_path: str, bundle: ModelBundle | None) -> None:
    ...
    with right:
        ...
        st.markdown("**Summary**")
        summary_text, summary_method = generate_anomaly_summary_with_method(analysis)
        st.write(summary_text)
        if summary_method == "llm":
            st.caption("Generated by LLM")
        else:
            st.caption("Generated by rule-based analysis")
